...
//			System.out.println("fetch");
	...
	// add new student teacher at user table;
	
//	public int adduser(String name, String email, String pass, String val)
//	{
//		Connection conn = null;
//		PreparedStatement stmt = null;
//		ResultSet rs = null;
...
//			
//			conn = datasource.getConnection();
//			String sql = "insert into users (user_name,email, password, type) values (?,?, ?,?)";

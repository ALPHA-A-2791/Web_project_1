...
<body class="bg-gray-900">
  ...
  <div class="max-w-md mx-auto my-8 grid p-6 rounded shadow-md flex-col justify-center items-center">
  ...
  <form method="post" action="create_course">
    <div class="mb-4">
      ...
      <input type="text" id="title" name="title" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-300 text-gray-100"  required>
    </div>
    <div class="mb-4">
      <label for="code" class="block font-medium text-gray-200">Course Code</label>
      <input type="text" id="code" name="code" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-300 text-gray-100" required>
    </div>
    <div class="mb-4">
      <label for="instructor" class="block font-medium text-gray-200">Instructor</label>
      <select id="instructor" name="instructor" class="form-select mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-300 text-gray-100" style="height: 3rem;" required>
